...
<div class="responsive-margin-bottom">
  <a class="nhm-btn--blue" href="https://www.nathanmagyar.com/portfolio-chat-frontend/" target="_blank">View the Alpha Version</a>
</div>
...
<div class="responsive-margin-bottom">
  ...
  <ul>
    ...
    <li><p class="my-0">Dynamic visual content that syncs with conversation (coming soon)</p></li>
  </ul>
</div>
...
<div class="responsive-margin-bottom">
  ...
  <ul>
    ...
    <li><p class="my-0">Easy access to the real me for deeper conversations</p></li>
...
<div class="responsive-margin-bottom">
  ...
  <ul>
    <li><p class="my-0">✅ Generate MVP voice clone with 10 short, high-quality-recordings</p></li>
    <li><p class="my-0">✅ Write comprehensive case study content</p></li>
    <li><p class="my-0">🕓 Record more detailed voice samples (15-30 min)</p></li>
    <li><p class="my-0">🕓 Create knowledge base with projects, skills, philosophy</p></li>
  </ul>
</div>

<div class="responsive-margin-bottom">
  <h2 data-sidebar>Tools I'm using</h2>
  <ul>
...
<div class="responsive-margin-bottom">
  ...
  <ul>
    ...
    <li><p class="my-0">Graceful fallbacks with option to contact the real me</p></li>
  </ul>
</div>